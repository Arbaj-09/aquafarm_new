      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 scroll-fade-in">
          <form onSubmit={handleSubmit} className="space-y-6 bg-white border border-gray-200 p-8 rounded-lg shadow-lg">
            ...
            <div>
              <label className="block text-gray-800 font-semibold mb-2">Product of Interest *</label>
              <select
                required
                className="w-full px-4 py-2 border border-gray-300 rounded bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            ...
            <div>
              <label className="block text-gray-800 font-semibold mb-2">Estimated Quantity</label>
              <input
                type="text"
                className="w-full px-4 py-2 border border-gray-300 rounded bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            ...
            <div>
              <label className="block text-gray-800 font-semibold mb-2">Additional Information</label>
              <textarea
                rows={5}
                className="w-full px-4 py-2 border border-gray-300 rounded bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
